...
const InputFile or String = require('./InputFile or String')
...
class InputMediaDocument {
    ...
    * @param {string} type
    * @param {string} media
    * @param {InputFile or String|null} [thumb]
   ...
   */
    ...
    * @returns {InputFile or String|null}
   */
   get thumb() {
       return this._thumb
   }
   ...
   */
   ...
   static deserialize(raw) {
      return new InputMediaDocument(
          raw['type'], 
          raw['media'], 
          raw['thumb'] ? InputFile or String.deserialize(raw['thumb']) : null, 
